...
import { IsGreaterThanOrEqualToProperty } from './IsGreaterThanOrEqualToProperty';

describe('IsGreaterThanOrEqualToProperty', () => {
  class TestObjectWithoutOpts {
    @IsGreaterThanOrEqualToProperty('fieldB')
    fieldA: any;
    fieldB: any;
  }
  ...
  class TestObjectWithTransformA {
    @IsGreaterThanOrEqualToProperty('fieldB', {transformA: (v) => v + 1})
    fieldA: any;
    fieldB: any;
  }
  class TestObjectWithTransformB {
    @IsGreaterThanOrEqualToProperty('fieldB', {transformB: (v: number) => v - 1})
    fieldA: any;
    fieldB: any;
  }
  class TestObjectWithTransformAB {
    @IsGreaterThanOrEqualToProperty('fieldB', {transformA: (v) => v + 1, transformB: (v: number) => v - 1})
    fieldA: any;
    fieldB: any;
  }
